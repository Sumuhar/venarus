(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".venarus__slider")) new core(".venarus__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                centeredSlides: true,
            ...
            if (document.querySelector(".opinion__slider")) new core(".opinion__slider", {
        ...
        da.init();
        function runLine(el, duration) {
            const innerEl = el.querySelector(".runline__image");
        ...
        const block1 = document.querySelector(".runline__block-1");
        const block2 = document.querySelector(".runline__block-2");
        const block3 = document.querySelector(".runline__block-3");
        runLine(block1, 2e4);
        runLine(block2, 2e4);
        runLine(block3, 2e4);
